...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("Jul 15, 2025 00:00:00").getTime(),
...
new TypeIt("#teks1", {
  strings: [
    "Happy birthday to the most special person – Meri Madam ji...",
    "Mere liye tu duniya ki sabse khoobsurat ladki hai. I wish tera birthday sabse best ho",
    "Agar kabhi tujhe kisi ka haath chahiye ho saath ke liye, toh me hmesha tera hath pakde rahunga.",
    "Meine kabhi nahi socha tha ki mujhe koi life me itna zyada pasand aayega jiske bina me reh nahi paunga",
    "Yeh ek simple birthday wish lag sakti hai, lekin ismein utna pyaar chhupa hai jitna tu soch bhi nahi sakti.",
  ],
  startDelay: 4000,
  speed: 75,
